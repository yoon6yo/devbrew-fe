      ...
      <div className="bg-white border border-[#e8e0f0] rounded-xl p-10 w-full max-w-sm shadow-[0_4px_16px_rgba(124,58,237,0.08)]">
        ...
        <div className="space-y-3">
          <a
            ...
            className="flex items-center justify-center gap-3 w-full border border-[#e8e0f0] rounded-lg px-4 py-3 text-[14px] font-bold text-[#2a2433] hover:border-[#d9cce8] hover:bg-[#f3f0ec] transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(124,58,237,0.25)]"
          >
            <GoogleIcon />
            Google로 계속하기
          </a>
        ...
        <p className="text-center text-[12px] text-[#8b8398] mt-8">
          로그인 시 <span className="text-[#4a4458]">이용약관</span> 및 <span className="text-[#4a4458]">개인정보처리방침</span>에 동의하게 됩니다.
        </p>
      </div>
    </div>
  )
